...
echo stylesheet_tag(theme_path('css/bootstrap.min.css'));

?>
</head>
<body>
<?php include("navbar_nabi.php");?>
<div class="content-index-page">
    <div class="row">
        <div class="col-lg-2 col-md-4 col-sm-6 col-xs-12 sidebar-content">
...
<script type="text/javascript">
    ...
    include("js/jquery-2.1.1.min.js");
